...
C_SRCS += \
../Core/Librerias/My_PWM.c \
../Core/Librerias/My_adc.c 

OBJS += \
./Core/Librerias/My_PWM.o \
./Core/Librerias/My_adc.o 

C_DEPS += \
./Core/Librerias/My_PWM.d \
...
clean-Core-2f-Librerias:
	-$(RM) ./Core/Librerias/My_PWM.cyclo ./Core/Librerias/My_PWM.d ./Core/Librerias/My_PWM.o ./Core/Librerias/My_PWM.su ./Core/Librerias/My_adc.cyclo ./Core/Librerias/My_adc.d ./Core/Librerias/My_adc.o ./Core/Librerias/My_adc.su
