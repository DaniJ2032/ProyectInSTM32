...
../Core/Librerias/My_uart.c 

OBJS += \
./Core/Librerias/My_adc.o \
./Core/Librerias/My_uart.o 

C_DEPS += \
./Core/Librerias/My_adc.d \
./Core/Librerias/My_uart.d 
...
clean-Core-2f-Librerias:
	-$(RM) ./Core/Librerias/My_adc.cyclo ./Core/Librerias/My_adc.d ./Core/Librerias/My_adc.o ./Core/Librerias/My_adc.su ./Core/Librerias/My_uart.cyclo ./Core/Librerias/My_uart.d ./Core/Librerias/My_uart.o ./Core/Librerias/My_uart.su
